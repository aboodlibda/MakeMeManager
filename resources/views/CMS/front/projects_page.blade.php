            ...
            <div class="col-md-6 col-sm-12">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Projects Page Elements</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#addUser">Add image</a></li>
                </ul>
                <div class="tab-content mt-0">
                    ...
                    <div class="tab-pane show active" id="addUser">
                        ...
                        @endif
                        <div class="body mt-2">
                            <form action="{{route('storeProjectsPage')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                {{method_field('POST')}}
                                <div class="row clearfix">

                                    <div class="col-lg-6 col-md-12">
                                        <label>Projects Page Image </label>
                                        ...
                                        <div class="image-area mt-2">
                                            ...
                                            <img id="imageResult" src="#" alt="" class="img-thumbnail rounded shadow-sm mx-sm-2" style="height: 100px;width: 100px">
