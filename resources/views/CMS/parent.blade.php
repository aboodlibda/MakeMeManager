...
{{--                            <a href="page-login.html" class="icon-menu"><i class="icon-power"></i></a>--}}
    ...
    <div id="left-sidebar" class="sidebar">
        <div class="navbar-brand">
            <a href="index.html"><img src="{{asset('Dashboard/assets/images/icon.svg')}}" alt="Oculux Logo" class="img-fluid logo"><span>Oculux</span></a>
                ...
                <ul id="main-menu" class="metismenu">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a href="{{route('projectsPage')}}">Projects Page</a></li>
                            ...
                            <li><a href="{{route('howItWorkPage')}}">How It Work Page</a></li>
