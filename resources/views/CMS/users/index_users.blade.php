...
{{--                                            <span></span>--}}
{{--                                        </label>--}}
                                        <img src="{{asset('imageUsers/'.$user->image)}}" data-toggle="tooltip" data-placement="top" title="{{$user->name}}" alt="Avatar" class="w35 h35 rounded">
                                    </td>
                                    <td>{{$user->name}}</td>
                                    <td>{{$user->email}}</td>
                                    <td>{{$user->gender}}</td>
                           ...
                           <div class="pagination mb-0"> {!! $users->render("pagination::bootstrap-4") !!} </div>
                        </div>
                    </div>
                        ...
                        <div class="body mt-2">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="jop" id="jop" class="form-control" placeholder="jop title *">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <textarea name="address" id="address" rows="4" type="text"
