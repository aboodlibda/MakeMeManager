                ...
                <div class="row clearfix">
                    ...
                    <div class="col-xl-12 col-lg-6 col-md-6">
                        <div class="card">
                            ...
                            <div class="body">
                                <form action="{{route('profile',$user->id)}}" method="PUT">
                                <div class="row clearfix">
                                    @csrf
                                    ...
                                    <div class="col-lg-4 col-md-12">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="jop" id="jop" class="form-control" placeholder="Jop" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                        <textarea name="address" id="address" rows="4" type="text" class="form-control"
