                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" name="requested_financing" id="requested_financing" value="{{$project->requested_financing}}" class="form-control money-dollar" placeholder="Ex: 99,99 $">
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        ...
                                        <div class="input-group mb-3">
                                            <input data-provide="datepicker" name="publication_date" data-date-autoclose="true" class="form-control" data-date-format="yyyy-mm-dd" value="{{$project->publication_date}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        ...
                                        <div class="image-area mt-2"><img id="imageResult" src="{{asset('Images/'.$project->image)}}" alt="" class="img-thumbnail rounded shadow-sm mx-sm-2">
{{--                                        <img src="{{asset('Images/'.$project->image)}}" class="img-thumbnail rounded shadow-sm mx-sm-2">--}}
                                        </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" name="funding_goal" id="funding_goal" class="form-control money-dollar" placeholder="Ex: 99,99 $" value="{{$project->funding_goal}}">
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" name="minimum_amount" id="minimum_amount" class="form-control money-dollar" placeholder="Ex: 99,99 $" value="{{$project->minimum_amount}}">
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="number" name="duration" id="duration" class="form-control money-dollar" placeholder="Ex: 99,99 $" value="{{$project->duration}}">
                                        </div>
                            ...
                            <div class="body">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <br>
                                        <br>
                                        <textarea id="ckeditor" name="description" >{{$project->description}}</textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 mg-t-20 mg-lg-t-0" id="type">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" name="reward_description" >{{$project->reward_description}}</textarea>
                                            </div>                                        </div><!-- col-4 -->


                                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="invoice_number">
                                            <p class="mg-b-10">Investment ratio (%)</p>
                                            <input type="text" class="form-control" id="invoice_number" name="investment_ratio" value="{{$project->investment_ratio}}">
