        ...
        <div class="container">
            <div class="row justify-content-center align-items-center" >
                <div class="col-lg-9 text-center mt-5">
                    <h1 class="heading" data-aos="fade-up">My Funded Projects</h1>
                    <nav aria-label="breadcrumb" data-aos="fade-up" data-aos-delay="200">
                        <ol class="breadcrumb text-center justify-content-center">
                            <li class="breadcrumb-item "><a href="{{route('home')}}">Home</a></li>
                            <li class="breadcrumb-item active text-white-50" aria-current="page">My Funded Projects</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="section section-4 border-top">
        <div class="container">
            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="col-lg-6">
                        <p><a href="{{route('funded.index')}}" class="btn btn-primary text-white py-3 px-4">Browse All Projects</a></p>
                    </div>
                    <div class="body">
                        <div class="row clearfix">
