...
@section('content')
    ...
    <div class="hero page-inner" style="background-image: url('dashboard/assets/images/my-projects.jpg')">
        <div class="container">
            <div class="row justify-content-center align-items-center" >
                <div class="col-lg-9 text-center mt-5">
                    <h1 class="heading" data-aos="fade-up">My Projects</h1>
                    <nav aria-label="breadcrumb" data-aos="fade-up" data-aos-delay="200">
                        <ol class="breadcrumb text-center justify-content-center">
                            <li class="breadcrumb-item "><a href="{{route('home')}}">Home</a></li>
                            <li class="breadcrumb-item active text-white-50" aria-current="page">My Projects</li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            @foreach($projects as $project)
                                <div class="col-sm-6 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                                    <div class="box-feature mb-5">
                                        ...
                                        <div>
                                        <a href="{{route('projects.edit',$project->id)}}"> {{--Edit Project--}}
                                            <button type="submit" class="btn btn-info btn-sm"><span class="sr-only"></span> <i class="icon-edit"></i></button>

                                        </a>
                                        <a href="{{route('projects.destroy',$project->id)}}"> {{--Delete Project--}}
                                        <button type="submit" class="btn btn-danger btn btn-sm"><span class="sr-only"></span> <i class="icon-delete"></i></button>
                                        </a>
                                        </div>
                                    </div>
                                </div>
