...
<head>
    <title>Make Me Manager | Financier Login</title>
    <meta charset="utf-8">
    ...
    <div class="auth_div vivify fadeInTop">
        <div class="card">
            <div class="body">
                ...
                <form class="form-auth-small" action="{{route('save.financier.login')}}" method="POST">
                    @csrf
                    <div class="mb-3">
                        <p class="lead">Login to Financier account</p>
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <span>Don't have an account? <a href="{{ route('financier.register') }}">Register</a></span>
                    </div>
                </form>
                <div class="pattern">
                    <span class="red"></span>
